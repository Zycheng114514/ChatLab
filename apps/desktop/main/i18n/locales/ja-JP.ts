...
export default {
  ...
  database: {
    ...
    migrationV11Desc: 'メッセージ検索用の全文インデックスを追加',
    migrationV11Message:
      'メッセージ本文の全文インデックスを作成してキーワード検索を高速化します（チャットデータは変更されません）',
    migrationV12Desc: 'メッセージ添付ファイルの保存領域を追加',
    migrationV12Message:
      'メディアファイル情報のテーブルを追加し、インポートした画像・音声・ファイルを表示できるようにします。既存のメッセージは変更されません',
    integrityError:
